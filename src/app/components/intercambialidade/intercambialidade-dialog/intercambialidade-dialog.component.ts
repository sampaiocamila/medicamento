...
import { SheetComponent } from '../../shared/layout/sheet';
...
@Component({
  selector: 'intercambialidade-dialog',
  templateUrl: 'intercambialidade-dialog.component.html',
  styles: [
...
export class IntercambialidadeDialogComponent implements AfterViewInit, OnDestroy {
