...
import { AfterViewInit, Component, OnDestroy, ViewEncapsulation, ChangeDetectionStrategy, Input } from '@angular/core';
...
@Component({
  selector: 'intercambialidade',
  templateUrl: 'intercambialidade.component.html',
  styleUrls: ['./intercambialidade.component.scss'],
  preserveWhitespaces: false,
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.Emulated
})

export class IntercambialidadeComponent implements AfterViewInit, OnDestroy {
  ...
  public elementListEvent(e: ElementListEvents) {
    if (e) {
      if (e.view) {
        this._form = this.service.datas.find((data) => e.view.id_dispensacao == data.id_dispensacao);
  ...
  public builderData (data): ControlBuilder[] {
    return [
      ...
      {
        displayed: 'Intercambialidade', placeholder: '',
        favorite: '7', name: 'icons', value: this.getIntercambialidade(data),
        validators: [], disabled: true, hideRequired: true
      },
    ];
  }
